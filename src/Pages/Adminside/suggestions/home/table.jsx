  ...
  const tableData = [
    {
      ...
      plateform: "Linked In",
      date: "2023-11-10",
      suggestions: "Lorem Ipsum ha sido el texto de relleno estándar de las...",
    },
    {
      username: "John Doe",
      email: "johndoe@gmail.com",
    ...
    <table className='w-full min-w-max text-sm md:text-base'>
      <thead>
        <tr className='text-white text-left text-xs md:text-base table-row bg-blue-500'>
          ...
          <th className='p-4 rounded-tr-lg'>Suggestions</th>
        </tr>
      </thead>
      <tbody>
        {tableData?.map((item, index) => (
          <tr key={index} className='border-t md:table-row'>
            <td className='p-4 flex items-center gap-4'>
              <img src='/images/suggestions-avatar.png' alt='' />
              {item.username}
            </td>
            ...
            <td className='p-4'>{item.suggestions}</td>
          </tr>
        ))}
      </tbody>
    </table>
