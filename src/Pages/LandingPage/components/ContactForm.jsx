...
export default function ContactForm() {
  return (
    <div
      className="flex items-center justify-center mt-10 md:mt-0 md:mr-20 h-[70vh] ml-10 mr-10 rounded-xl md:h-[80vh] bg-[#B2E7B9] md:bg-transparent"
      style={{
    ...
    >
      <div className="bg-transparent p-6 md:p-8 w-[90%] md:w-[70%] rounded-lg px-5">
        ...
        <div className="flex flex-col md:flex-row items-center gap-2 md:gap-4 justify-center">
          ...
          <button className="bg-[#52CC8A] text-white px-8 py-2 md:px-14 md:py-3 rounded-full">
            Subscribe
          </button>
        </div>
