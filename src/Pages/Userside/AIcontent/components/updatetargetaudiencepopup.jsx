...
const UpdateTargetAudiencePopup = ({ isVisible, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center">
      <div className="bg-white p-6 rounded-lg w-1/2 overflow-y-auto max-h-[100vh]">
        <h1 className="text-xl font-semibold mb-4">Edit Target Audience</h1>
...
export default UpdateTargetAudiencePopup;
