import ViewedVideosCards from "./cards"
import ViewedVideosLineChart from "./linechart"
import ViewedVideosListOfVideosTable from "./listofvideostable"
  ...
  return (
    <>
      <div className='bg-white rounded-md py-2 px-4 md:py-4 md:px-8 mt-4'>
        <div className='text-xl font-bold'>Viewed Videos</div>
        <div className='grid grid-cols-2 md:grid-cols-6 gap-2 mt-4'>
          <ViewedVideosCards />
        </div>
        <ViewedVideosLineChart />
      </div>
