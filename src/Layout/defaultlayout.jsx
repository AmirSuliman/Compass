...
const DefaultLayout = ({ children }) => {
  return (
    <div className="relative w-full overflow-hidden bg-[#f8f8f8] text-black">
      ...
      <div className="absolute bottom-2 left-10 xl:bottom-[15%] xl:left-[15%] w-150 rounded-full h-96 opacity-10 blur-2xl"></div>
      <div
      ...
      <div className="flex flex-row h-screen overflow-hidden w-full">
        ...
        <div className="relative flex flex-1 flex-col min-h-screen overflow-y-auto overflow-x-hidden w-full">
          <Header />
          <main className="p-4 md:p-6 2xl:p-10 bg-[#f8f8f8] flex-1 w-full">
